import { BookOpen, Home, Leaf, PawPrint, Truck, Wrench } from "lucide-react";
...
const categories = [
  {
    icon: Truck,
    label: "Delivery",
    count: "2,140 tasks this week",
    slug: "DELIVERY",
  },
  {
    icon: Home,
    label: "Cleaning",
    count: "1,820 tasks this week",
    slug: "CLEANING",
  },
  {
    icon: Wrench,
    label: "Repair",
    count: "1,460 tasks this week",
    slug: "REPAIR",
  },
  {
    icon: BookOpen,
    label: "Tutoring",
    count: "1,180 tasks this week",
    slug: "TUTORING",
  },
  {
    icon: Leaf,
    label: "Gardening",
    count: "940 tasks this week",
    slug: "GARDENING",
  },
  {
    icon: PawPrint,
    label: "Pet care",
    count: "820 tasks this week",
    slug: "PET_CARE",
  },
];
      ...
      <div className="mx-auto px-8" style={{ maxWidth: 1360 }}>
        ...
        <div className="flex justify-between items-end gap-8 flex-wrap mb-12">
          <div>
            ...
            >
              What people get{" "}
              <em className="text-ds-orange not-italic">doable</em>.
            </h2>
          </div>
          <p
            ...
            style={{ maxWidth: 480 }}
          >
            From quick favors to weekly help — these are the categories filling
            up fastest in your area this week.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {categories.map(({ icon: Icon, label, count, slug }) => (
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-ds-orange-soft text-ds-orange-ink flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-[13px] text-ds-ink-3 font-medium m-0">
                  {count}
                </p>
              </div>
            </Link>
