...
const timeline = [
  {
    ...
    year: "2024",
    title: "The spark",
    body: "Two friends needed a plumber and a dog-walker on the same day. Five apps later, nothing. GetItDone was born out of frustration.",
  ...
  },
  {
    ...
    year: "Late 2025",
    title: "Going public",
    body: "Thousands of verified users, full escrow support, and a mobile-first redesign. GetItDone became the go-to platform in 12 cities.",
