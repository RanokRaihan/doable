...
> = {
  ...
  PAYMENT_PROCESSING: { label: "Payment Processing", className: "bg-purple-100 text-purple-700 border-purple-200" },
  COMPLETED: { label: "Completed", className: "bg-green-100 text-green-700 border-green-200" },
  PAYMENT_FAILED: { label: "Payment Failed", className: "bg-red-100 text-red-700 border-red-200" },
...
const categoryPlaceholders: Record<string, string> = {
  REPAIR: "https://images.unsplash.com/photo-1581578731117-104f2a41272c?q=80&w=200&auto=format&fit=crop",
  GARDENING: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?q=80&w=200&auto=format&fit=crop",
  MOVING: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=200&auto=format&fit=crop",
  CLEANING: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?q=80&w=200&auto=format&fit=crop",
  DEFAULT: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=200&auto=format&fit=crop",
};
