...
We reserve the right to update these Terms at any time. Continued use of the Platform after any changes constitutes your acceptance of the revised Terms.
...
- **Clients** post tasks, set budgets, and hire Helpers.
- **Helpers** browse tasks, submit offers or bids, and complete tasks in exchange for payment.
- Users may act as both Clients and Helpers on the Platform.
...
To use core features of the Platform, you must register for an account. You agree to:
...
## 4. Posting and Completing Tasks

### 4.1 Client Responsibilities

When posting a task, Clients agree to:

- Provide **clear, accurate, and complete** descriptions of the task, including location, timeline, and any special requirements.
- Post only **lawful tasks** that do not violate applicable laws or these Terms.
- **Honor accepted offers** and pay Helpers upon satisfactory completion of work.
- Treat Helpers with **respect and professionalism**.

### 4.2 Helper Responsibilities

When accepting or bidding on tasks, Helpers agree to:

- Only accept tasks they are **qualified and capable** of completing.
- Complete tasks in a **professional, timely, and high-quality** manner.
- **Communicate clearly** with Clients about progress, delays, or issues.
- Comply with all applicable **licenses, permits, and regulations** for the work performed.
- Treat Clients and their property with **care and respect**.

### 4.3 Prohibited Task Categories

Users may not post or accept tasks involving:

- Illegal goods, services, or activities of any kind
- Firearms, weapons, explosives, or dangerous materials
- Adult content, escort services, or prostitution
- Hacking, unauthorized surveillance, or cybercrime
...
- The Client marks the task as **complete**, or
- The task is deemed complete based on dispute resolution outcomes, or
- An agreed-upon milestone is reached.

### 5.4 Refunds and Cancellations

Refund eligibility depends on the stage of the task:

- Tasks cancelled **before a Helper is assigned**: Full refund.
- Tasks cancelled **after a Helper is assigned**: Subject to cancellation policy and any work already completed.
- Completed tasks: Refunds are only issued through the formal dispute resolution process.
...
You agree to use the Platform only for lawful purposes and in a manner consistent with these Terms. You must not:
...
- Engage in scraping, crawling, or data mining of the Platform without written permission.
- Interfere with or disrupt the integrity or performance of the Platform.
- Circumvent any technological measure designed to protect the Platform or its users.

### 6.2 Content Standards

Any content you post on the Platform — including task descriptions, profiles, reviews, messages, and photos — must:

- Be **accurate and not misleading**.
- Not contain **hate speech, obscenity, or offensive material**.
...
Both Clients and Helpers may leave reviews and ratings after a completed task. Reviews must be:

- **Honest and based on genuine experience** with the task.
...
Your use of the Platform is also governed by our [Privacy Policy](/privacy), which is incorporated into these Terms by reference. Please review it carefully to understand how we collect, use, and share your information.
...
- Any **injury, loss, or damage** resulting from tasks performed through the Platform.
- Any **personal data breach** resulting from a user's own security practices.
...
Upon termination, your right to access and use the Platform ceases immediately. Sections of these Terms that by their nature should survive termination (including Sections 9, 12, 13, and 15) will remain in effect.

---

## 15. Governing Law

These Terms are governed by and construed in accordance with the laws of the **State of Delaware, United States**, without regard to its conflict of law provisions. You consent to the exclusive jurisdiction of courts located in Delaware for any disputes that are not subject to arbitration.
...
Your continued use of the Platform after such notice constitutes your acceptance of the updated Terms. We recommend reviewing this page periodically.
